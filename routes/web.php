...
Route::get('/dashboard','HomeDashboardController@index')->middleware(['CheckUser'])->name('home.dashboard');

Route::group(['prefix' => 'dashboard'], function () {
    Route::get('login','HomeDashboardController@getLogin')->middleware(['CheckLogout'])->name('login.dashboard.admin.get');
    Route::post('login','HomeDashboardController@PostLogin')->name('login.dashboard.admin');
    Route::get('logout','HomeDashboardController@getLogout')->name('logout.dashboard.admin');
...
Route::get('dang-xuat','ManagerUserController@logout')->name('logout.index.list');
